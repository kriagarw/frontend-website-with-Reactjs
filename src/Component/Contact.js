...
import { Breadcrumb, BreadcrumbItem, FormGroup, Input, Label, Col, Button } from 'reactstrap';
                    ...
                    <div className="col-12 col-md-9">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={6}>
                                    <Input type="textarea" id="message" name="message" placeholder="Your Feedback" rows="6" value={this.state.message} onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
